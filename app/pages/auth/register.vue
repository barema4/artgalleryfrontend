  ...
  <div class="min-h-[80vh] flex items-center justify-center py-12 px-4">
    <div class="w-full max-w-md">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-gray-600 mt-2">Start your art journey today</p>
      </div>
      ...
      <form class="space-y-5" @submit.prevent="handleSubmit">
        ...
        <p class="text-xs text-gray-500">
          ...
          <NuxtLink to="/terms" class="text-gray-900 hover:underline">Terms of Service</NuxtLink>
          and
          <NuxtLink to="/privacy" class="text-gray-900 hover:underline">Privacy Policy</NuxtLink>.
        </p>
      ...
      <div class="space-y-3">
        <button
          type="button"
          class="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-200 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors"
        >
